...
```{r Orange Circumference Against Age, echo=FALSE}
colors<-c("blue","red","green","maroon","purple")

# Data taken was days since "1968/12/31" we will use that to create a new variable TreeAge
...
```{r Orange Circumference Over Group, echo=FALSE}
